...
felix = Dog("Felix", "Bulldog", 16)

print(f"{felix.name} is a {felix.breed} and is {felix.age}")
...
class Country:
      ...
      jersey = Country("Jersey", 14, 1220,)




      def country_info(self):
        print(f"{jersey.country} is {jersey.age} years old with a population of {jersey.population} people")
